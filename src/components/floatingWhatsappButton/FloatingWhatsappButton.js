...
const FloatingWhatsappButton = () => {
	...
	return (
		<a href='https://api.whatsapp.com/send?phone=17863841030' target='_blank' rel='noreferrer' ref={fromRef} className={isVisible ? 'floating-whatsapp--img-container' : 'hidden'}>
